 ...
 * @param font 字体
 */
exports.measureTextWidth = (0, utils_1.memoize)(function (text, font) {
    if (font === void 0) { font = {}; }
    ...
    var metrics = ctx.measureText((0, utils_1.isString)(text) ? text : '');
    return metrics.width;
}, function (text, font) {
    if (font === void 0) { font = {}; }
    return __spreadArray([text], (0, utils_1.values)(font), true).join('');
});
